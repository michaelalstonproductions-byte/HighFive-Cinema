...
enum HFEcosystemCommandData {
    static let metrics: [HFEcosystemMetric] = [
        ...
        HFEcosystemMetric(title: "Personalized", value: "Local paths", caption: "Static smart recommendations", systemImage: "sparkles")
    ]
    ...
    static let priorities: [HFEcosystemPriority] = [
        ...
        HFEcosystemPriority(title: "Open PersonalizedHubView", subtitle: "Review local paths across watch, create, connect, and launch.", destinationType: "personalizedHub", status: "For You", systemImage: "sparkles"),
    ...
    static let createItems: [HFEcosystemCommandItem] = [
        ...
        HFEcosystemCommandItem(title: "Creator Command Center", subtitle: "Track workflow and readiness.", category: "Create", status: "72%", systemImage: "command", destinationType: "creatorCommand"),
        ...
        HFEcosystemCommandItem(title: "Asset Manager", subtitle: "Review artwork and materials.", category: "Create", status: "Review", systemImage: "rectangle.stack.fill", destinationType: "assetManager"),
    ...
    static let connectItems: [HFEcosystemCommandItem] = [
        ...
        HFEcosystemCommandItem(title: "Watch Party Preview", subtitle: "Open shared viewing preview.", category: "Connect", status: "Mock", systemImage: "play.tv.fill", destinationType: "watchParty"),
    ...
    static let launchItems: [HFEcosystemCommandItem] = [
        ...
        HFEcosystemCommandItem(title: "Release Presentation", subtitle: "Open partner preview.", category: "Release", status: "Ready", systemImage: "rectangle.on.rectangle.angled.fill", destinationType: "releasePresentation"),
        HFEcosystemCommandItem(title: "Demo Checklist", subtitle: "Walk local QA routes.", category: "Release", status: "QA", systemImage: "checklist.checked", destinationType: "demoChecklist"),
    ...
    static let personalizedItems: [HFEcosystemCommandItem] = [
        ...
        HFEcosystemCommandItem(title: "Smart Recommendations", subtitle: "Review recommended next actions.", category: "Personalized", status: "Ready", systemImage: "wand.and.stars", destinationType: "personalizedHub"),
    ...
    static let demoItems: [HFEcosystemCommandItem] = [
        ...
        HFEcosystemCommandItem(title: "Demo Checklist", subtitle: "Review local QA routes without capturing or exporting files.", category: "Demo", status: "Local", systemImage: "checklist.checked", destinationType: "demoChecklist"),
    ...
    static let smartNextStepPath: [HFEcosystemPathStep] = [
        ...
        HFEcosystemPathStep(title: "PersonalizedHubView", systemImage: "sparkles"),
