...
enum HFMockData {
    nonisolated static let movies: [Movie] = [
        Movie(
            ...
            creatorName: "InTheLight Productions",
            isOriginal: true,
            isComingSoon: false,
            isDownloaded: false,
            progress: 0.42
        ...
        Movie(
            id: "paranormall-s1",
            title: "Paranormall",
            subtitle: "Short Micro Vertical Horror",
            synopsis: "A mall security guard discovers an Ouija board during a quiet shift and unlocks something truly horrific inside the mall.",
            year: "2026",
            rating: "TV-14",
            duration: "7 episodes",
