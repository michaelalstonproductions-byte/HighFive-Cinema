...
enum HFMockData {
    static let movies: [Movie] = [
        Movie(
            ...
            posterAssetName: "TheFriendly_Poster_Master",
        ...
        Movie(id: "bleu-velvet", title: "Bleu Velvet", subtitle: "Lust. Lies. Loyalty.", synopsis: "A private lounge becomes the center of a choice between business and truth.", year: "2026", rating: "TV-MA", duration: "Feature", genres: ["Crime", "Drama"], posterAssetName: "poster_bleu_velvet_coming_soon", backdropAssetName: "poster_bleu_velvet_coming_soon", creatorName: "HighFive Cinema", isOriginal: true, isComingSoon: true, isDownloaded: false, progress: nil),
        ...
        Movie(id: "house-of-keys", title: "House of Keys", subtitle: "Development slate", synopsis: "A symbolic thriller about access, inheritance, and what one family kept locked away.", year: "2027", rating: "Setup Required", duration: "TBA", genres: ["Thriller"], posterAssetName: nil, backdropAssetName: nil, creatorName: "HighFive Cinema", isOriginal: true, isComingSoon: true, isDownloaded: false, progress: nil),
        ...
        Movie(id: "gold-room", title: "The Gold Room", subtitle: "Short film", synopsis: "A chamber drama about a deal that should have stayed private.", year: "2025", rating: "TV-14", duration: "31m", genres: ["Drama"], posterAssetName: nil, backdropAssetName: nil, creatorName: "HigherKey Studios", isOriginal: false, isComingSoon: false, isDownloaded: true, progress: nil),
        Movie(id: "city-after", title: "City After Midnight", subtitle: "Local library", synopsis: "A neon noir about a courier making one last run through a city that records everything.", year: "2025", rating: "TV-MA", duration: "54m", genres: ["Noir", "Action"], posterAssetName: nil, backdropAssetName: nil, creatorName: "HighFive Cinema", isOriginal: false, isComingSoon: false, isDownloaded: false, progress: 0.12)
    ]
    ...
    static var recommended: Category {
        Category(
            ...
            movies: ["black-turnip", "sunshine", "arrival-time", "maple-street", "city-after", "night-file"].compactMap(movie)
        )
    }
    ...
    static func galleryAssets(for movie: Movie) -> [String] {
        let assets = [
            ...
            "the_friendly",
            "paranormall",
            "poster_artist_development_coming_soon"
        ]
        return Array(Set(assets.compactMap { $0 })).prefix(5).map { $0 }
    }
