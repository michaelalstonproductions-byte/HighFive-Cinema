...
export const v3CreatorCRMContactsPath = "/v3/creator-crm/contacts";
export const v3CreatorCRMCompaniesPath = "/v3/creator-crm/companies";
export const v3CreatorCRMContactsImportCSVPath = "/v3/creator-crm/contacts/import-csv";
export const v3CreatorCRMContactLinksPath = "/v3/creator-crm/contacts/link";
...
export const v3HighFiveEnterpriseSummaryPath = "/v3/highfive-enterprise/summary";
export const v3HighFiveEnterpriseGlobalCreatorPath = "/v3/highfive-enterprise/global-creator-platform";
export const v3HighFiveEnterpriseStudioPlatformPath = "/v3/highfive-enterprise/enterprise-studio-platform";
export const v3HighFiveEnterpriseAIStreamingPath = "/v3/highfive-enterprise/ai-streaming-platform";
export const v3HighFiveEnterpriseLaunchReadinessPath = "/v3/highfive-enterprise/launch-readiness";
