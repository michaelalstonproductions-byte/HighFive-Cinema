...
DERIVED="/Volumes/Scratch SSD/XcodeDerivedData/highfive-32-0b-library-downloads-evidence"
APP_PATH="$DERIVED/Build/Products/Debug-iphonesimulator/HighFive.app"
BUILD_LOG="$OUT_DIR/${c}_library_downloads_xcodebuild.log"
mkdir -p "$SHOT_DIR"
...
capture_route "downloads_offline_asset_service.png" --hf-skip-onboarding --hf-start-downloads
capture_route "library_${c}_sync_readiness.png" --hf-skip-onboarding --hf-start-library
capture_route "movie_detail_offline_eligibility.png" --hf-skip-onboarding --hf-start-movie-detail
capture_route "home_library_downloads_signal.png" --hf-skip-onboarding --hf-start-home
capture_route "profile_library_downloads_services.png" --hf-skip-onboarding --hf-start-profile
capture_route "demo_library_downloads_proof.png" --hf-skip-onboarding --hf-start-demo-tour
...
{
  printf '# Cloud Library Downloads Screenshot Manifest\n\n'
  printf -- '- Upgrade: #032.0B\n'
  printf -- '- Build: passed\n'
  printf -- '- Install: passed\n'
...
printf 'Cloud Library Downloads screenshots captured.\n'
printf 'Manifest: %s\n' "$MD_MANIFEST"
