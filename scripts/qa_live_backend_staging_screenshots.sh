...
JSON_OUT="$OUT_DIR/live_backend_staging_screenshot_manifest.json"
MD_OUT="$OUT_DIR/live_backend_staging_screenshot_manifest.md"
DERIVED_DATA="/Volumes/Scratch SSD/XcodeDerivedData/highfive-54-0b-live-backend-staging-evidence"
...
capture_route "backend_status_local.png" --hf-start-backend-status
capture_route "profile_backend_services.png" --hf-skip-onboarding --hf-start-profile
capture_route "creator_backend_readiness.png" --hf-skip-onboarding --hf-start-creator-studio
capture_route "home_backend_status.png" --hf-skip-onboarding --hf-start-home
...
{
  echo "# Live Backend Staging Screenshot Manifest"
  echo
  echo "- Upgrade: #054.0B"
  echo "- Status: $STATUS"
  echo "- Build: pass"
