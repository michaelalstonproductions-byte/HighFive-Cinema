...
BUILD_LOG="$OUT_DIR/watch_first_product_ux_xcodebuild.log"
MANIFEST_JSON="$SCREENSHOT_DIR/watch_first_product_ux_screenshot_manifest.json"
MANIFEST_MD="$SCREENSHOT_DIR/watch_first_product_ux_screenshot_manifest.md"
DERIVED_DATA="/Volumes/Scratch SSD/XcodeDerivedData/highfive-49-0b-watch-first-ux-evidence"
...
{
  printf -- '# Watch-First Product UX Screenshot Manifest\n\n'
  printf -- '- Upgrade: #049.0B\n'
  printf -- '- Status: `%s`\n' "$status"
  printf -- '- Build: `pass`\n'
  printf -- '- Build log: `%s`\n\n' "$BUILD_LOG"
