...
MANIFEST_JSON="$OUT_DIR/storekit_paywall_movie_id_mapping_screenshot_manifest.json"
JSON_OUT="$OUT_DIR/storekit_paywall_movie_id_mapping_screenshot_verification.json"
MD_OUT="$OUT_DIR/storekit_paywall_movie_id_mapping_screenshot_verification.md"
...
{
  printf -- '# StoreKit Paywall Movie-ID Mapping Screenshot Verification\n\n'
  printf -- '- Upgrade: #060.0B\n'
  printf -- '- Status: %s\n' "$status"
...
printf -- 'StoreKit paywall movie-ID mapping screenshot verification passed.\n'
